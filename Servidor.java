...
public class Servidor {
	...
	public static void main(String[] args) throws Exception{
		...
		if ( d == 0 ||  d % 2 == 0){
			System.out.println("Matriz inválida, determinante da matriz é 0"
								+ " " + "ou determinante é par.");
		} 
		else {
			// verificação se matriz é válida.
			...
			if (ok == 0) {
				System.out.println("Matriz inválida, números  primos entre si. ");
				in.close();
			}
		} // fim da validação.
